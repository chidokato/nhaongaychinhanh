...
Route::get('profile/login','c_profile@getlogin'); // đăng nhập
Route::post('profile/login','c_profile@postlogin'); // đăng nhập
Route::get('profile/signup','c_profile@getsignup'); // đăng ký
Route::post('profile/signup','c_profile@signup'); // đăng ký
Route::get('profile/sendcapchar/{email}','c_ajax@sendcapchar'); // gửi mã xác nhận về mail
Route::get('profile/resetpassword','c_profile@resetpassword'); // Quên mật khẩu
Route::post('profile/resetpassword','c_profile@postresetpassword'); // Quên mật khẩu

Route::group(['prefix'=>'profile','middleware'=>'profile'],function(){
	Route::get('','c_profile@profile');
	Route::post('postprofile/{id}','c_profile@postprofile');

	Route::group(['prefix'=>'articles'],function(){
		Route::get('listitem','c_profile@listitem');
		Route::get('post','c_profile@post');
		Route::post('post','c_profile@postpost');
		Route::get('edit/{id}','c_profile@edit');
		Route::post('edit/{id}','c_profile@postedit');
		Route::get('delete/{id}','c_profile@getdelete');
	});
	Route::post('search_post','c_profile@search_post');
	Route::get('changepassword','c_profile@changepassword');
	Route::post('postchangepassword/{id}','c_profile@postchangepassword');
	Route::get('logout','c_profile@logout'); // logout

	// Route::get('ajax/changecategory/{id}','c_ajax@changecategory');
	// Route::get('ajax/change_province/{id}','c_ajax@change_province');
	// Route::get('ajax/change_district/{id}','c_ajax@change_district');
	// Route::get('ajax/change_district_street/{id}','c_ajax@change_district_street');
	// Route::get('ajax/change_none','c_ajax@change_none');
});


Route::get('/','c_frontend@home');

Route::get('frontend/ajax/changecategory/{id}','c_ajax@changecategory');
Route::get('frontend/ajax/change_province/{id}','c_ajax@change_province');
Route::get('frontend/ajax/change_district/{id}','c_ajax@change_district');
Route::get('frontend/ajax/change_district_street/{id}','c_ajax@change_district_street');
Route::get('frontend/ajax/change_none','c_ajax@change_none');

Route::get('messages','c_frontend@messages');
Route::get('/search','c_frontend@search');

Route::POST('search-product','c_frontend@search_product');
